...
/**
 * Local 8K textures used between the 2K base and the streamed tiles (public/textures/8k/<name>.jpg): Solar System Scope
 * (CC BY 4.0), except the Moon (NASA SVS CGI Moon Kit: LROC colour, LOLA relief) and Mars (USGS Viking colour mosaic,
 * MOLA relief), generated by tools/planet_maps.py. `normal` is a sharper tangent-space relief map swapped in with the map.
 */
export const HIRES = {
  earth: { map: '8k_earth_daymap', night: '8k_earth_nightmap', cloud: '8k_earth_clouds' },
  moon: { map: '8k_moon', normal: '4k_moon_normal' }, mars: { map: '8k_mars', normal: '4k_mars_normal' }, mercury: { map: '8k_mercury' }, venus: { map: '8k_venus_surface' },
