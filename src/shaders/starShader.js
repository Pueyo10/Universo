...
// size/alpha from flux, a glare halo and faint diffraction spikes for the
// brightest, all driven by a global exposure uniform.
export const nearStarVert = /* glsl */`
  attribute float lum;
...
export const nearStarFrag = /* glsl */`
